...
//                                ?>
                            ...
                            @if(Auth::user()->status == 1)
                            <td>
                                <a href="#" data-toggle="modal" data-target=".bs-example-modal-assign" orderid="{{$staff_detail['order_id']}}" orderitemid="{{$staff_detail['orderitemid']}}" userroleId="{{$staff_detail['userrole_id']}}"class="assign"><span style="color: red; text-decoration: underline;">{{$staff_detail['name']}}</span></a>
                            </td>
                            <td><?php if ($staff_detail['orderstatus'] == 1) { ?>
                                <span class="label label-primary">
                                    Processing </span>
                                <?php } else if ($staff_detail['orderstatus'] == 4) { ?>
                            ...
                            <td>
                                @if (Auth::user()->status == 1)
                                    <a class="icon-btn notehistory" data-toggle="modal" href="#notes" orderitemid="{{$staff_detail['orderitemid']}}">
                                        ...
                                        <?php
                                        $idd = trim($staff_detail['orderitemid']);
                                        $count = '';
                                        if (isset($commentcount[$idd])) {
                                            $count = $commentcount[$idd];
                                        }
                                        ?>
                                        @if ($count!='') 
                                    ...
                                    @if($staff_detail['orderstatus'] == 4)
                                    <a class="icon-btn reaction" orderid="{{$staff_detail['order_id']}}" orderitemid="{{$staff_detail['orderitemid']}}" data-toggle="modal" href="#reaction">
                                        <i class="fa fa-bullhorn"></i>
                                        <div>
                                            Reaction 
                                        </div>
                                    </a>
                                    <a class="icon-btn lastcomplete" mail="{{$staff_detail['email']}}" orderid="{{$staff_detail['order_id']}}" orderitemid="{{$staff_detail['orderitemid']}}" data-toggle="modal" href="#lastcomplete">
                                ...
                                @elseif (Auth::user()->status == 0)
                                    ...
                                    @if($staff_detail['orderstatus'] == 1)
                                    <a class="icon-btn order_complete" orderid="{{$staff_detail['order_id']}}" orderitemid="{{$staff_detail['orderitemid']}}" data-toggle="modal" href="#staffcomplete">
                                        <i class="fa fa-thumbs-up"></i>
                                        <div>
                                            complete 
                                        </div>
                                    ...
                                    @endif
                                    <a class="icon-btn reject-order" orderusersid="{{$staff_detail['orderusersid']}}" orderid="{{$staff_detail['order_id']}}" orderitemid="{{$staff_detail['orderitemid']}}" data-toggle="modal" href="#reject">
...
<div class="modal fade" id="lastcomplete" tabindex="-1" role="lastcomplete" aria-hidden="true">
     <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="portlet">
                <div class="portlet-body form">
                    <form method="post" action="{{ URL::to('lastcomplete') }}" id="" class="form-horizontal">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <div class="portlet">
                <div class="portlet-body form">
                    <form method="post" action="{{ URL::to('ordernote') }}" id="submitnote" class="submitnote form-horizontal">
                        ...
                        <input type="hidden" name="formname"  value="0">
                        <div class="form-body">
                            <div class="alert alert-danger display-hide">
                                <button class="close" data-close="alert"></button>
                                You have some form errors. Please check below.
                        ...
                        <div class="modal-footer">
                            <!--                            <button data-dismiss="modal" class="btn btn-default close_note" type="button">
                                                            Close
                                                        </button>-->
                            <input type="submit" name="close" value="Close" class="btn btn-default close_note">
                            <input type="submit" name="sent" value="Sent Comment!" class="btn btn-info remove-staff">
                        </div>
                    </form>
                </div>
            </div>
                                        ...
                                        <div class="input-group input-large">
                                            ...
                                            <span class="input-group-addon btn default btn-file">
                                                ...
                                                <span class="fileinput-exists">
                                                    Change </span>
                                                <input type="file" name="submitfile[]" multiple="" required="" placeholder="Upload File">
                                            </span>
