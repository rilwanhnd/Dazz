        ...
        <ul class="sidebar-menu">
            ...
            <!--<li>
                <a href="#"><i class='fa fa-link'></i> 
                    <span>{{ trans('adminlte_lang::message.anotherlink') }}</span>
                </a>
            </li>
            <li class="treeview">
                <a href="#"><i class='fa fa-link'></i> <span>{{ trans('adminlte_lang::message.multilevel') }}</span> 
            ...
            <li class="">
                <a href="{{ url('manage_order') }}">
                    <i class='fa fa-gear'></i> <span>{{ "Manage Order" }}</span>
                </a>
            </li>
            <li class="">
                <a href="{{ url('configs') }}">
