            ...
            if (is_array($fieldType)) {
                if ($this->isComplexType($fieldType[0])) {
                    ...
                    if ($elements->length >= 1) {
                        require_once (str_replace("MarketplaceWebService\\", "", str_replace('_', DIRECTORY_SEPARATOR, $fieldType[0]) . ".php"));
                ...
                if ($this->isComplexType($fieldType)) {
                    $elements = $xpath->query("./a:$fieldName", $dom);
                    if ($elements->length == 1) {
                        require_once (str_replace("MarketplaceWebService\\", "", str_replace('_', DIRECTORY_SEPARATOR, $fieldType) . ".php"));
